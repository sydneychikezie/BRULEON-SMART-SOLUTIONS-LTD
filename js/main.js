...
form.addEventListener("submit", (e) => {
  ...
  fetch(scriptURL, { method: "POST", body: new FormData(form) })
    .then((response) => {
      ...
      setTimeout(() => {
        alert(
          "Thank you for contacting BRULEON Smart Solutions. We look forward to the possibility of collaborating with you and making sustainable smart solutions accessible to all🤝."
        );
